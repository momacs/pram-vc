...
left_plot = row(column(*this_inputs.get_sliders(), btn_submit, width = 200), column(p1, p2, p3), width = 1200)
# right_plot = row(column(r1, r2, r3), column(*that_inputs.get_sliders(), btn_submit, width = 200),  width = 1000)
plots = row(left_plot, width = 1200)
input = row(column(width = 400), column(cycle, width = 600))
